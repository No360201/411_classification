...
class ShuffleNetV1(nn.Module):
    def __init__(self, input_size=224, num_classes=1000, model_size='2.0x', group=None):
        ...
        self.classifier1 = nn.Sequential(nn.Linear(self.stage_out_channels[-1], num_classes, bias=False))
...
def shufflenet_v1(pretrained=False,**kwargs):
    model = ShuffleNetV1(group=3,**kwargs)
    return model
