...
def resnext50(class_num):
    ...
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 6, 3],class_num)


def resnext101(class_num):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 23, 3],class_num)


def resnext152(class_num):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 36, 3],class_num)